...
struct evmc_message
{
     ...
     * For ::EVMC_DELEGATECALL, this may be different from the evmc_message::code_address.
     *
     ...
     *
     * For ::EVMC_DELEGATECALL this may be different from the evmc_message::recipient.
